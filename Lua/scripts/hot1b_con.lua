...
function ScriptInit()
    ...
    SetupTeams{
        ...
        all = {
            ...
            engineer = { "all_inf_sniper_snow",1, 4},
            sniper   = { "all_inf_medic",1, 4},
            officer = {"all_inf_heavy_snow",1, 4},
            special = { "all_inf_wookie_snow",1, 4},
		...
		imp = {
            ...
            sniper   = { "imp_inf_medic_atat",1, 4},
            officer = {"imp_inf_heavy",1, 4},
            special = { "imp_inf_jettrooper_long",1, 4},
		},
    }
	
	AddUnitClass(ALL, "all_hero_han",1,2)
	AddUnitClass(ALL, "all_hero_luke_jedi_snow",1,2)
