...
function ScriptPostLoad()
 ...
 --Objective 3
	...
	Objective21.OnStart = function(self)
		...
		SetHeroClass(REP, "rep_hero_mace")
		UnlockHeroForTeam(1)
		AcceptHero(0)
		...
		Objective21.DroidKill = OnObjectKill( 
			function(object, killer) 
				if killer and IsCharacterHuman(killer) and GetObjectTeam(object) == DEF then
					if GetObjectLastHitWeaponClass(object) == "rep_weap_lightsaber_mace" or GetObjectLastHitWeaponClass(object) == "com_weap_inf_force_push" then
	...
	Objective6a.OnStart = function(self)
		AddUnitClass(1, "rep_inf_ep2_medic", 4)
	...
	Objective9.OnStart = function(self)
		...
		Objective9DroidKill = OnObjectKill( 
			function(object, killer) 
				if killer and IsCharacterHuman(killer) and GetObjectTeam(object) == DEF and GetObjectLastHitWeaponClass(object) == "rep_weap_inf_Valken" then
	...
	Objective10a.OnStart = function(self)
		MapAddEntityMarker("c_cp3", "hud_objective_icon_circle", 4.0, ATT, "YELLOW", true, true, true)
		AddUnitClass(1, "rep_inf_ep2_jettrooper", 3)
	...
	Objective11a.OnStart = function(self)
		...
		AddUnitClass(1, "rep_inf_ep2_rocketeer_c", 3)
	...
	Spider = TargetType:New{classname = "cis_walk_spider", killLimit = 1, weapon = "rep_weap_inf_launcher", killedByPlayer = true, icon = "hud_target_hint_onscreen"}
...
function ScriptInit()
    ...
    SetupTeams{
        ...
        cis = {
            ...
            engineer = { "cis_inf_medic",3},
            sniper   = { "cis_inf_sniper",4},
            officer = {"cis_inf_heavy",2},
