...
function ScriptInit()
    ...
    SetupTeams{
        ...
        rep = {
			...
			engineer = { "rep_inf_ep3_sniper_white",1, 4},
			sniper   = { "rep_inf_ep3_medic_white",1, 4},
			officer = {"rep_inf_ep3_heavy_white",1, 4},
	...
	AddUnitClass(CIS, "cis_inf_rocketeer_radiation",1,2)
