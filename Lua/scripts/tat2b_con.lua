...
function ScriptInit()
	...
	SetupTeams{
		all = {
            ...
            sniper   = { "all_inf_medic_merc",1, 4},
            officer = {"all_inf_heavy",1, 4},
            special = { "all_inf_jawa",1, 4},
		...
		imp = {
			...
			units = 28,
			reinforcements = 150,
			soldier  = { "imp_inf_rifleman_sand",9, 25},
            assault  = { "imp_inf_rocketeer_sand",1, 4},
            engineer = { "imp_inf_sniper",1, 4},
            sniper   = { "imp_inf_medic_atst",1, 4},
            officer = {"imp_inf_heavy_sand",1, 4},
            special = { "imp_inf_tusken",1, 4},
		},
	}
