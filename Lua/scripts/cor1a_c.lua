   ...
   ReadDataFile("SIDE\\rep.lvl",
    ...
    SetupTeams{             
        rep = {
            ...
            engineer = { "rep_inf_ep3_sniper",3, 4},
            sniper   = { "rep_inf_ep3_medic",2, 4},
            officer = {"rep_inf_ep3_heavy",2, 4},
    ...
    SetupTeams{ 
        all = {
            ...
            units = 8,
            reinforcements = -1,
            soldier  = { "rep_inf_ep3_rifleman_jed",3, 4},
            assault =   { "rep_inf_ep3_rifleman_jed",3, 4},
    ...
    SetupTeams{ 
        jedi = {
            ...
            units = 17,
            reinforcements = 0,
            soldier  = { "rep_inf_ep3_rifleman_jed",4, 6},
            assault  = { "jed_knight_02",4, 6},
            engineer  = { "jed_knight_03",3, 6},
            sniper = { "jed_knight_02",2, 6},
        }
    }
    ...
    SetupTeams{
    	bos = {
    		...
    		reinforcements = 3,
    		soldier = { "jed_knight_04", 1, 1 },
    		assault = { "jed_knight_04", 1, 1 },
    		engineer = { "jed_knight_04", 1, 1 },
    	}
    }
	
	AddUnitClass(REP, "rep_hero_anakin",1,2)
	AddUnitClass(REP, "rep_hero_palp",1,2)
