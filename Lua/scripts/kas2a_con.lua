...
function ScriptInit()
    ...
    SetupTeams{
        ...
        rep = {
            ...
            units = 32,
            reinforcements = 150,
            soldier  = { "rep_inf_ep3_rifleman_forest",9, 25},
			assault  = { "rep_inf_ep3_rocketeer_forest",1, 4},
			engineer = { "all_inf_wookie_warrior",1, 4},
			sniper   = { "rep_inf_ep3_medic_white_long",1, 4},
        ...
        cis = {
            ...
            special = { "all_inf_trando",1, 4},
        }
     }
    
	AddUnitClass(REP, "rep_inf_commando",1,2)
	AddUnitClass(REP, "rep_hero_masteryoda",1,2)
	
	AddUnitClass(CIS, "cis_inf_commando",1,2)
    AddUnitClass(CIS, "cis_inf_officer_o",1,2)
