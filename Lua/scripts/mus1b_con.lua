...
SetupTeams{
    all = {
        ...
        soldier  = { "all_inf_rifleman",9, 25},
            ...
            sniper   = { "cis_inf_rifleman_all",1, 4},
            officer = {"all_inf_heavy",1, 4},
            special = { "all_hero_bothan",1, 4},
...
SetupTeams{
    imp = {
        ...
        units = 32,
        reinforcements = 150,
        soldier  = { "imp_inf_rifleman_magma",9, 25},
            assault  = { "imp_inf_rocketeer_magma",1, 4},
            engineer = { "imp_inf_sniper",1, 4},
            sniper   = { "imp_inf_medic",1, 4},
            officer = {"imp_inf_heavy",1, 4},
            special = { "imp_inf_flametrooper",1, 4},
	 ...
	 AddUnitClass(ALL, "all_hero_wedge",1,2)
	 
	 AddUnitClass(IMP, "imp_inf_darktrooper",1,2)
	 AddUnitClass(IMP, "imp_hero_dengar",1,2)
