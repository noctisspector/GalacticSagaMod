   ...
   -- set up teams
    SetupTeams{
        imp = {
            ...
            soldier  = { "tfo_inf_rifleman",7, 25},
            assault  = { "tfo_inf_rocketeer",1, 4},
            engineer = { "tfo_inf_sniper",1, 4},
            sniper   = { "tfo_inf_medic",1, 4},
            officer = {"tfo_inf_heavy",1, 4},
            special = { "tfo_inf_flametrooper",1, 4},
        ...
        all = {
            ...
            soldier  = { "res_inf_rifleman",7, 25},
            assault  = { "res_inf_rocketeer",1, 4},
            engineer = { "res_inf_sniper",1, 4},
            sniper   = { "res_inf_medic",1, 4},
            officer = {"res_inf_heavy",1, 4},
            special = { "res_inf_jettrooper",1, 4},
        }
    }
   -- SetHeroClass(ALL, "all_hero_luke_jedi")    
    --SetHeroClass(IMP, "imp_hero_emperor")
	--res_hero_rey_TFA
	AddUnitClass(IMP, "tfo_hero_phasma",1,2)
	AddUnitClass(IMP, "tfo_hero_kylo",1,2)
	
	AddUnitClass(ALL, "res_hero_han",1,2)
	AddUnitClass(ALL, "res_hero_rey_TFA",1,2)
