...
function ScriptInit()
	...
	SetupTeams{
		all = {
			...
			units = 28,
			reinforcements = 150,
			soldier  = { "rep_inf_cody_np",4, 10},
            assault  = { "rep_inf_bacara_np",4, 10},
            engineer = { "rep_hero_kenobi_np",4, 10},
            sniper   = { "rep_inf_bly_np",4, 10},
            officer = {"rep_hero_mace_np",4, 10},
            special = { "rep_hero_aalya_mod_np",4, 10},
		...
		imp = {
			...
			units = 28,
			reinforcements = 150,
			soldier  = { "cis_hero_jango_np",4, 10},
            assault  = { "rep_hero_anakin_np",4, 10},
            engineer = { "cis_hero_dooku_np",4, 10},
            sniper   = { "rep_hero_palp_np",4, 10},
            officer = {"cis_hero_maul_np",4, 10},
            special = { "cis_hero_grievous_mod_np",4, 10},
		},
	}
    
	AddUnitClass(ALL, "rep_hero_kiyadi_np",4,10)
