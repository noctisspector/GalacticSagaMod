...
function ScriptInit()
    ...
    SetupTeams{
        ...
        rep={
            ...
            --reinforcements = 160,
            reinforcements = 60,
            soldier  = { "rep_inf_ep3_rifleman_marine"},
			assault  = { "rep_inf_ep3_rocketeer_marine"},
			engineer = { "rep_inf_ep3_sniper_white"},
			sniper   = { "rep_inf_ep3_medic_white"},
			officer = {"rep_inf_ep3_heavy_white"},
			special = { "rep_inf_ep3_jettrooper_white",1, 4},
	...
	AddUnitClass(REP, "rep_inf_bacara",1,2)
	AddUnitClass(REP, "rep_hero_kiyadi",1,2)
