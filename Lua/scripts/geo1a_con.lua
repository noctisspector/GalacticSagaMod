...
SetupTeams{
        ...
        rep = {
			...
			sniper   = { "rep_inf_ep2_medic",1, 4},
			officer = {"rep_inf_ep2_heavy",1, 4},
	...
	--Works fine by self
	AddUnitClass(REP, "rep_hero_ep2kenobi",1,2) 
	--
	AddUnitClass(REP, "rep_hero_mace",1,2)
	
	AddUnitClass(CIS, "cis_inf_officer_o",1,2)
	AddUnitClass(CIS, "cis_hero_dooku",1,2)
