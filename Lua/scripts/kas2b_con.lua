...
function ScriptInit()
    ...
    SetupTeams{
        ...
        all={
            ...
            engineer = { "all_inf_wookie_warrior",1, 4},
            sniper   = { "all_inf_medic",1, 4},
            officer = {"all_inf_wookie_gunner",1, 4},
            special = { "all_inf_wookie_sapper",1, 4},
        ...
        imp={
            ...
            units = 29,
            reinforcements = 150,
            soldier  = { "imp_inf_rifleman_shore",9, 25},
            assault  = { "imp_inf_rocketeer_shore",1, 4},
            engineer = { "imp_inf_sniper_long",1, 4},
            sniper   = { "imp_inf_medic_groundcrew",1, 4},
            officer = {"imp_inf_heavy",1, 4},
            special = { "imp_inf_jettrooper_pulse",1, 4},
        }
    }

    AddUnitClass(ALL, "all_inf_katarn",1,2)
	AddUnitClass(ALL, "all_inf_chewie",1,2)
	 
	 AddUnitClass(IMP, "imp_inf_deathtrooper_long",1,2)
	 AddUnitClass(IMP, "imp_hero_bossc",1,2)


	SetTeamName(3, "locals")
    SetTeamIcon(3, "all_icon")
    AddUnitClass(3, "all_inf_wookie_warrior",2)
    AddUnitClass(3, "all_inf_wookie_gunner",2)
    AddUnitClass(3, "all_inf_wookie_sapper",1)
