...
SetupTeams{
    rep = {
        ...
        units = 32,
        reinforcements = 150,
        soldier = { "rep_inf_ep3_rifleman_fel",9, 25},
        assault = { "rep_inf_ep3_rocketeer_fel",1, 4},
        engineer = { "rep_inf_ep3_sniper_forest",1, 4},
        sniper  = { "rep_inf_ep3_medic_arf",1, 4},
        officer = { "rep_inf_ep3_heavy_fel",1, 4},
        special = { "rep_inf_ep3_jettrooper_fel",1, 4},
...
AddUnitClass(REP, "rep_inf_bly",1,2)
AddUnitClass(REP, "rep_hero_aalya_mod",1,2)
	
AddUnitClass(CIS, "cis_inf_officer_o",1,2)
AddUnitClass(CIS, "cis_hero_jango",1,2)
