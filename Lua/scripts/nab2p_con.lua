...
function ScriptInit()
    ...
    SetMemoryPoolSize ("Combo::Transition",900) -- should be a bit bigger than #Combo::State
    ...
    SetMemoryPoolSize ("Combo::Deflect",800)     -- should be ~1x #combo
...
--    			"gar_inf_vanguard") 
    ...
    SetupTeams{
        ...
        rep = {
            ...
            units = 32,
            reinforcements = 150,
            soldier  = { "rep_inf_ep3_rifleman_nab",9, 25},
			assault  = { "rep_inf_ep3_rocketeer_nab",1, 4},
			engineer = { "rep_inf_ep3_sniper_nab",1, 4},
			sniper   = { "rep_inf_ep3_medic_nab",1, 4},
			officer = {"rep_inf_ep3_heavy_nab",1, 4},
			special = { "rep_inf_guard_nab",1, 4},
	...
	AddUnitClass(REP, "rep_inf_padme",1,2)
	AddUnitClass(REP, "rep_hero_jinn",1,2)
	
	AddUnitClass(CIS, "cis_hero_maul",1,2)
    AddUnitClass(CIS, "rep_hero_palp",1,2)
