 ...
 function ScriptInit()
    ...
    SetupTeams{
        ...
        imp={
            ...
            units = 32,
            reinforcements = 150,
            soldier  = { "imp_inf_rifleman_swamp",9, 25},
            assault  = { "imp_inf_rocketeer_swamp",1, 4},
            engineer = { "imp_inf_sniper",1, 4},
            sniper   = { "imp_inf_medic",1, 4},
            officer = {"imp_inf_heavy",1, 4},
            special = { "imp_inf_storm",1, 4},
        }
    }

    
	--AddUnitClass(ALL, "all_hero_wedge",1,2)
	 --AddUnitClass(ALL, "all_hero_nien",1,2)
