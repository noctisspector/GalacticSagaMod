...
function ScriptInit()
    ...
    SetupTeams{
        ...
        cis = {
            ...
            units = 32,
            reinforcements = 150,
            soldier  = { "rep_inf_ep3_rifleman_jed",7, 25},
            assault  = { "jed_knight_02",1, 4},
            engineer = { "jed_knight_03",1, 4},
            sniper   = { "jed_knight_04",1, 4},
            officer = {"rep_hero_kenobi",1, 2},

        }
     }
    
	--AddUnitClass(REP, "rep_inf_commando",1,2)rep_hero_palp
	AddUnitClass(REP, "rep_hero_anakin",1,2)
	AddUnitClass(REP, "rep_hero_palp",1,2)
	
	AddUnitClass(CIS, "rep_hero_masteryoda",1,2)
