ParticleEmitter("ChargeGlow")
{
	...
	Spawner()
	{
		...
		Red(200.0000, 200.0000, 200.0000);
		Green(200.0000, 200.0000, 200.0000);
		Blue(200.0000, 200.0000, 200.0000);
	...
	Transformer()
	{
		...
		{
			LifeTime(0.1000)
			Reach(200.0000,200.0000,200.0000,128.0000);
			Next()
			{
				LifeTime(0.4000)
				Reach(200.0000,200.0000,200.0000,175.0000);
			}
		}
	}
	Geometry()
	...
	ParticleEmitter("Flare")
	{
		...
		Spawner()
		{
			...
			Red(0, 120.0000, 242.0000);
			Green(0, 17.0000, 54.0000);
			Blue(0, 0.0000, 17.0000);
			Alpha(0, 0.0000, 0.0000);
